<template>
  <div>
    <h1>Hello, Monova! This is monitoring app.</h1>
    <p>Welcome to your new single-page application, built with: </p>
    <ul>
      <li><a href="https://get.asp.net/">
          <icon :icon="['fab', 'microsoft']" /> ASP.NET Core</a> and <a href="https://msdn.microsoft.com/en-us/library/67ef8sbd.aspx">C#</a> for cross-platform server-side code</li>
      <li><a href="https://vuejs.org/">
          <icon :icon="['fab', 'vuejs']" /> Vue.js</a> for client-side code</li>
      ...
      <li><a href="https://fontawesome.com">
          <icon :icon="['fab', 'font-awesome']" /> Font Awesome</a> (Free) for the icons</li>
    ...
    <p><a href="mailto:hello@devhelp.online">
        <icon icon="envelope" /> Hello@DevHelp.Online</a></p>
  </div>
</template>
